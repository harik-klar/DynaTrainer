...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mult_simple = __webpack_require__(201);

	var _mult_simple2 = _interopRequireDefault(_mult_simple);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_mult_simple2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MultiplySimple = function (_Component) {
	  _inherits(MultiplySimple, _Component);

	  function MultiplySimple(props) {
	    _classCallCheck(this, MultiplySimple);

	    var _this = _possibleConstructorReturn(this, (MultiplySimple.__proto__ || Object.getPrototypeOf(MultiplySimple)).call(this, props));

	    _this.state = { op1: Math.floor(Math.random() * 11), op2: Math.floor(Math.random() * 13), ans: '' };
	    return _this;
	  }

	  _createClass(MultiplySimple, [{
	    key: 'checkAns',
	    value: function checkAns() {
	      if (this.state.op1 * this.state.op2 == this.state.ans) console.log("correct");else console.log("wrong!!!!");
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'number', onChange: function onChange(e) {
	              return _this2.setState({ ans: e.target.value });
	            }, placeholder: 'Answer', value: this.state.ans })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'col-md-1' },
	          _react2.default.createElement(
	            'button',
	            { type: 'submit', className: 'btn btn-primary', onClick: this.checkAns.bind(this) },
	            'OK'
	          )
	        )
	      );
	  ...
	  return MultiplySimple;
	}(_react.Component);

	exports.default = MultiplySimple;
